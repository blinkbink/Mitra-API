...
//	    	 e.printStackTrace();
  ...
  public User findByEmailMitra(String email, Long mitra) {
	  Query query=session.createQuery("select u from User u, Userdata ud where u.userdata=ud.id and u.nick = :email and (ud.mitra= :mitra or u.mitra =: mitra) ");
	     query.setString("email", email);
...
//		  System.out.println("DEBUG DB:" +(i++));
		  ...
		  User data=(User) session.createQuery("from User where nick ='"+user+"' and (status='3')").uniqueResult();
		  return data;
	  }
	  catch (Exception e) {
          LogSystem.error(getClass(), e);
...
//		  System.out.println("DEBUG DB:" +(i++));
		  ...
		  User data=(User) session.createQuery("from User where nick ='"+user+"' and (status='3' or status='1')").uniqueResult();
		  return data;
	  }
	  catch (Exception e) {
         LogSystem.error(getClass(), e);
 ...
 public User findByEmail(String user) {
	  try{
//		  System.out.println("DEBUG DB:" +(i++));
		  User data=(User) session.createQuery("from User where nick ='"+user+"' ").uniqueResult();
		  return data;
	  }
	  catch (Exception e) {
         LogSystem.error(getClass(), e);
