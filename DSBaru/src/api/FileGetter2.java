...
public class FileGetter2 extends HttpServlet {
	...
	String refTrx="GETF"+sdfDate2.format(tgl).toString();
	String kelas="api.FileGetter2";
	String trxType="GET-F";
	@Override
...
//	        System.out.println("MIME type: " + mimeType);
			...
			LogSystem.info(request, "application/pdf download", "api.FileGetter2", refTrx, "GET-F");
