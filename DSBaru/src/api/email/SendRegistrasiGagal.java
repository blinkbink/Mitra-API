...
public class SendRegistrasiGagal {
TrustManager[] trustAllCerts = new TrustManager[] {new X509TrustManager() {
	...
	public SendRegistrasiGagal() {
		// TODO Auto-generated constructor stub
	}
	public void kirim(String nama, String jk, String email, String informasi, String idmitra) {
		URL url = null;
		try {
			//url = new URL(DSAPI.EMAIL_API+"sendMailRegisterSuccess.html");
			url = new URL(DSAPI.EMAIL_API+"registrasigagal.html");
