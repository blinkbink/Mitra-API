...
public class SendMailPendaftaranUlang {
	...
	public SendMailPendaftaranUlang() {
	...
	public void kirim(String nama, String jk, String email, String idmitra, String eeuser, String mitraVer) throws Exception {
		URL url = null;
		try {
        ...
        String encryption = AESEncryption.encrypt(eeuser+"#"+mitraVer+"#"+strDate);
