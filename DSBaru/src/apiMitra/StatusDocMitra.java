...
public class StatusDocMitra extends ActionSupport {

	static String basepath="/opt/data-DS/UploadFile/";
	static String basepathPreReg="/opt/data-DS/PreReg/";
	//Date tgl= new Date();
	SimpleDateFormat sdfDate2 = new SimpleDateFormat("yyyyMMddHHmmssSSSSSS");
	String kelas="apiMitra.StatusDocMitra";
	...
	public void execute(JPublishContext context, Configuration cfg) {
		...
		try{
				...
				LogSystem.info(request, reqHead, kelas, refTrx, trxType);
				// no multipart form
				if (!isMultipart) {
				...
				// multipart form
					...
					for (FileItem fileItem : fileItems) 
					{
						...
						LogSystem.info(request, fileItem.getString(), kelas, refTrx, trxType);
...
//	         Log.info( "RECEIVE "+request.getRequestURI().toString() +"  : "+jsonString);
			 ...
			 if(jsonString==null) 
			 {
				LogSystem.info(request, "Json String null",kelas, refTrx, trxType+"/"+mitra.getName());
			 	return;	         
			 }
