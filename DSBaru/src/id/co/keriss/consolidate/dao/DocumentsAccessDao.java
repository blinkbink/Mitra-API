...
import id.co.keriss.consolidate.ee.EmailVO;
...
//		  query.setString("doc", document);  
	  ...
	  public List<DocumentAccess> findByDocAndEmail(String document, String email) {
		  String  qString="from DocumentAccess d where d.document =:doc and  email=:email  and (type='sign' or type='initials')";
		  Query query=session.createQuery(qString);
...
//		  if(ls.size()==0)return null;
	  ...
	  public List<DocumentAccess> findDocByCurrentSeq(Long document, int seq) throws HibernateException {
		  String  qString="select d from DocumentAccess d where d.document =:doc and d.sequence_no=:seq and (type='sign' or type='initials') and flag='false'";
		  Query query=session.createQuery(qString);
	  ...
	  public List<DocumentAccess> findAccessByAT(Long iddoc) throws HibernateException {
		  String  qString="select da "
					+ "from "
						+ "DocumentAccess da "
					+ "where "
						+ "da.document=:iddoc and "
						+ "(da.type='sign' or da.type='initials') and "
						+ "da.action='at'";
			Query query=session.createQuery(qString);
	  ...
	  public List<DocumentAccess> findAccessSignGroupByEmail(Long iddoc) throws HibernateException {
		  String  qString="select da "
					+ "from "
						+ "DocumentAccess da "
					+ "where "
						+ "da.document=:iddoc and "
						+ "(da.type='sign' or da.type='initials')";
		  Query query=session.createQuery(qString);
	  ...
	  public List<DocumentAccess> findAccessShareGroupByEmail(Long iddoc) throws HibernateException {
		  String  qString="select da "
					+ "from "
						+ "DocumentAccess da "
					+ "where "
...
//	    	log.debug(e);
	  ...
	  public  void update(DocumentAccess documentAccess) throws Exception {
		    try {
		      Transaction t= null;
...
//		    	log.debug(e);
  ...
  public  void update2(DocumentAccess documentAccess) {
		    try {
		      //Transaction t=session.beginTransaction();
		      session.update(documentAccess);
		      //t.commit();
