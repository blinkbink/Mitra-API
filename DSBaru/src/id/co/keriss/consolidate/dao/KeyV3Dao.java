...
public class KeyV3Dao {
	...
	public KeyV3Dao(Session s){
	  ...
	  public List<KeyV3> findByMitra(Long mitra) throws HibernateException {
		    return (List<KeyV3>) session.createQuery("from KeyV3 where mitra ='"+mitra+"' and status='ACT' order by id desc").list();
	  }
