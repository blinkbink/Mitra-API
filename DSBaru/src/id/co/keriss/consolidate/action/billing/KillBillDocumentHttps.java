...
public class KillBillDocumentHttps {
	...
	String kelas="id.co.keriss.consolidate.action.billing.KillbillDocumentHttps";
	...
	public JSONObject getBalance(String ex, HttpServletRequest request) throws KillBillClientException {
		...
		try{
			...
			String charset = "UTF-8";
	         ...
	         LogSystem.info(requ, "[POST] "+url+" "+req.toString());
			...
			*/
			...
			e.printStackTrace();
			try {
				LogSystem.info(requ, "getbalance timeout",kelas, refTrx, trxType);
				res.put("result", "91");
				return res;
