...
public class Billing {
	...
	public Billing(HttpServletRequest request, String refTrx) {
		// TODO Auto-generated constructor stub
		requ=request;
		this.refTrx=refTrx;
	}
			
	public JSONObject getBalance(String ex, HttpServletRequest request, String tenant) throws KillBillClientException {
		JSONObject res=null;
 		String sr ="";
 		int amount=0;
		try{
...
//			}
	...
	public JSONObject setTransaction(String ex, int amount, String doc_id, String tenant) throws KillBillClientException {
		JSONObject res=null;
 		String sr ="";
 		String invoice=null;
 		//int amount=0;
