...
public class StatusManager {
    ...
    static {
        severity.put (StatusBase.OK,       new Integer (SysLog.INFO));
        severity.put (StatusBase.OFF,      new Integer (SysLog.INFO));
        severity.put (StatusBase.WARN,     new Integer (SysLog.WARN));
        severity.put (StatusBase.ERROR,    new Integer (SysLog.ERROR));
        severity.put (StatusBase.CRITICAL, new Integer (SysLog.CRITICAL));
    }
        ...
        throws HibernateException, SQLException
    {
        ...
        Status s = null;
        try {
            s = db.session().load (Status.class, id);
