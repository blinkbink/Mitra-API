...
public class KMSRSAEncryption2 implements DSAPI {
...
//			PublicKey key = getPublic("/home/acx/Core_publicKey");
	...
	public String encryptWithPub(String data) {
		try {
			cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
