...
public class SendMailSSL implements DSAPI{
	...
	public SendMailSSL(HttpServletRequest request, String refTrx) {
...
//			System.out.println(response.toString());
			...
			LogSystem.info(request, "Response " + rst, refTrx , path_app,  Thread.currentThread().getStackTrace()[1].getLineNumber(), email_req, mitra_req, CATEGORY, (System.currentTimeMillis() - start) / 1000f + "s");
//			
