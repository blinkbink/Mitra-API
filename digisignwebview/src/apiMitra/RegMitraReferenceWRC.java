...
//
//
//public class RegMitraReferenceWRC extends ActionSupport {
//
...
//				
//			//}
//		}else if(new UserManager(db).findByEmail(jsonRecv.get("email").toString()) != null) {
//			//System.out.println("Check User already exist (null/exist): " + new UserManager(db).findByEmail(jsonRecv.get("email").toString()));
//			LogSystem.info(request, "Check User already exist (null/exist): " + new UserManager(db).findByEmail(jsonRecv.get("email").toString()),"");
...
//							LogSystem.info(request, "assssssssssssssssssssssssssssssssssssssssss" + result.toString(),"");
...
//								LogSystem.info(request, "Check data face","");
...
//				        LogSystem.info(request, "Masuk 2","");
//		
//		//		        DigiSign ds=null;
//		//	
...
//						
//				        LogSystem.info(request, "Masuk 3","");
