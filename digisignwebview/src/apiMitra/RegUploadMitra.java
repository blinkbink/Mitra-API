...
//	         
//	         JSONObject jo = null;
//	         jo=RegisterUserMitra(jsonRecv, fileSave, context, mitra, useradmin, request, refTrx);
//	         
//	         
//			String res="";
...
//	}
//	
//	JSONObject RegisterUserMitra(JSONObject jsonRecv,List<FileItem> fileSave, JPublishContext context, Mitra mitratoken, User useradmin, HttpServletRequest  request, String refTrx) throws JSONException{
//
//		boolean kirim=false;
//		User userRecv=null;
//		DB db = getDB(context);
