...
//		String refTrx="SNDDOC-MITRA"+sdfDate2.format(tgl).toString();
//		long filesize=0;
...
//						if(tm!=null) {
//							LogSystem.info(request, "Token ada","");
//							mitra=tm.getMitra();
//						} else {
...
//										if(jsonRecv.has("format_doc"))
//										{
//											LogSystem.info(request, "Format doc : " + jsonRecv.getString("format_doc"),"");
//											
...
//															LogSystem.info(request, "Delete aja","");
...
//												}
//												
//												LogSystem.info(request, "prf = "+prf,"");
...
//								  LogSystem.info(request, "Tandatnagan dokumen otomatis berhasil","");
//							  }
//							  else {
