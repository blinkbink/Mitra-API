...
public class SendSuksesRegistrasi {
	...
	public SendSuksesRegistrasi() {
		// TODO Auto-generated constructor stub
	}
	public void kirim(String nama, String jk, String email, String link, String idmitra) {
		URL url = null;
		try {
			//url = new URL(DSAPI.EMAIL_API+"sendMailRegisterSuccess.html");
			url = new URL(DSAPI.EMAIL_API+"sendMailRegister.html");
