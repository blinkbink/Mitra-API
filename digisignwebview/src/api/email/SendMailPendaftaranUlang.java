...
public class SendMailPendaftaranUlang {
	...
	public void kirim(String nama, String jk, String email, String eeuser, String mitraVer, String mitra_req, String CATEGORY, long start) throws Exception {
		URL url = null;
		try {
...
//			conn = (HttpURLConnection)url.openConnection();
			...
			LogSystem.info(request, response.toString(), refTrx, path_app, Thread.currentThread().getStackTrace()[1].getLineNumber(), email, mitra_req, CATEGORY, (System.currentTimeMillis() - start) / 1000f + "s");
	        in.close();
