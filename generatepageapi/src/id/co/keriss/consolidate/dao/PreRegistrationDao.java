...
public class PreRegistrationDao {
	...
	public PreRegistrationDao(DB db){
	  ...
	  public PreRegistration emailPerusahaan(String email) throws HibernateException {
		    return (PreRegistration) session.createQuery("from PreRegistration where lower(email_perusahaan) ='"+email+"'").uniqueResult();
	  }
